...
public class MouseOver {
    ...
    public void validarMouseOver () {
        ...
        Actions idk = new Actions(navegador);
        WebElement url = this.navegador.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div[2]/div/div[2]/span/p"));
        idk.moveToElement(url).perform();
