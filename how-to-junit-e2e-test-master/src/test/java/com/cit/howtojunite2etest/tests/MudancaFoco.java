...
public class MudancaFoco {
    ...
    public void validarAberturaNovaAba () {
        ...
        this.navegador.findElement(By.className("red")).click();

        ArrayList<String> idk = new ArrayList<String>(this.navegador.getWindowHandles());
        this.navegador.switchTo().window(idk.get(1));
    ...
    public void validarAberturaModal () {
        ...
        String display=this.navegador.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/div")).getCssValue("display");
        Assert.assertEquals("block", display);
